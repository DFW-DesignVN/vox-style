...
async function runBenchmark30s() {
  console.log('====================================================');
  console.log('🏁 BENCHMARK LEVEL 1: 30 SECONDS RENDER STRESS TEST');
  console.log('Target: 900 frames @ 30 FPS with Audio Muxing');
  ...
  // 2. Stream chunks (36 chunks of 25 frames)
  console.log(`[2/4] Streaming ${totalFrames / chunkSize} chunks of 25 frames...`);
  ...
  console.log(`[3/4] Transcoding 900 frames to 1080p H.264 & muxing AAC audio...`);
  ...
  console.log('\n====================================================');
  console.log('📊 BENCHMARK RESULTS (LEVEL 1: 30s / 900 FRAMES)');
  console.log('====================================================');
  console.log(`• Success:               ${result.success}`);
  console.log(`• Video URL:             ${result.videoUrl}`);
  console.log(`• Output File Size:      ${(stat.size / 1024).toFixed(1)} KB`);
  ...
  console.log('🎯 LEVEL 1 BENCHMARK PASSED 100%!');
}

runBenchmark30s().catch((err) => {
